...
<div class="tip"><strong>Recording tip:</strong> Use <a href="https://www.audacityteam.org/" target="_blank" style="color:#1abc9c;">Audacity</a> (free) to record greetings &mdash; noise reduction, normalization, and proper export settings will sound noticeably more professional than a phone recording.</div>
</div>
...
<strong>Disclaimer:</strong> This report was generated by an automated tool. While the data is read directly from the CUPI API,
the analysis (classifications, warnings, depth calculations, schedule filtering) is computed algorithmically and may not
perfectly reflect runtime call behavior. Always verify findings independently against the live system.
</div>
