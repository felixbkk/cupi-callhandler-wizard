...
<div style="position:fixed; bottom:0; left:0; right:0; z-index:9998; text-align:center; padding:6px 12px; background:#0d1b2a; border-top:1px solid #0f3460; font-size:11px; color:#888;">This report was generated by an automated tool. Verify all findings independently.</div>
<script>
(function() {{
